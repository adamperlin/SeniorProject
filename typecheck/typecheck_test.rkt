...
(check-exn (regexp (regexp-quote "bad operand type for '-: 'bool")) 
    (lambda () (typecheck-expr (UnOpExpr '- (IdExpr 'b)) test-env)))
...
(check-equal? (typecheck-function (parse-fundef big-def)) (void))
